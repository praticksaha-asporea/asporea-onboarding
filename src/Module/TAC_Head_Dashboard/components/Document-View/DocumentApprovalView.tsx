...
const DocumentApprovalView = () => {
  ...
  return (
    <Box className="w-full rounded-[20px] shadow-2xl p-4 md:p-8 font-sans bg-[var(--mui-palette-primary)]">
      ...
      <TableContainer
        component={Paper}
        className="shadow-xl bg-[var(--mui-palette-primary)]"
          ...
          <TableHead>
            <TableRow className="resp-thead">
              {COLS.map((head, i) => (
                <TableCell
                  key={i}
                  className={`py-4 px-4 font-semibold bg-[var(--mui-palette-primary)] text-[var(--mui-palette-secondary-main)] whitespace-nowrap ${head === "Actions" ? "text-right" : ""}`}
                >
                  {head}
                </TableCell>
              ))}
          ...
          <TableBody>
            {loading ? (
              ...
              leads.map((row: any) => (
                ...
                >
                  <TableCell className="py-3 px-4" data-label="Candidate">
                    <Typography className="font-semibold text-[var(--mui-palette-primary)] text-[13px]">
                      {row.fullName}
                    </Typography>
                    <Typography className="text-[12px] text-[var(--mui-palette-primary)] font-medium">
                      {row.inqNo || "N/A"}
                    </Typography>
                  </TableCell>
                  <TableCell
