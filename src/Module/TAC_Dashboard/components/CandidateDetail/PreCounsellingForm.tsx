    ...
    <>
              ...
              <Grid size={{ xs: 12, md: 4.5, lg: 4 }}>
                <Box className="h-full bg-[var(--mui-palette-background-default)] rounded-2xl p-6 flex flex-col items-center justify-center text-center relative overflow-hidden shadow-2xl gap-5">
                  ...
                  <Box className="flex flex-col items-center gap-2 w-full">
                    ...
                    />
                    <Box className="flex items-center gap-2 flex-wrap justify-end pt-5">
      ...
      >
        <Box className="flex items-center justify-between px-6 py-4 border-b border-[var(--mui-palette-divider)]">
          ...
          <IconButton size="small" onClick={() => setIsRescheduleOpen(false)} className="text-[var(--mui-palette-text-secondary)]">
            <i className="ri-close-line text-xl" />
          </IconButton>
        </Box>
        ...
        <Box className="flex justify-end gap-3 px-6 pb-6">
          ...
          >
            {rescheduling ? <CircularProgress size={18} color="inherit" /> : "Confirm New Slot"}
          </Button>
        </Box>
      </Dialog>
      ...
      >
        <Box className="flex flex-col items-center text-center p-6">
          <Box
            className="w-14 h-14 rounded-full flex items-center justify-center mb-4"
            style={{ background: "color-mix(in srgb, var(--mui-palette-error-main) 12%, transparent)" }}
          >
            <i className="ri-calendar-close-line text-2xl text-[var(--mui-palette-error-main)]" />
          </Box>
          <Typography variant="h6" className="font-bold mb-1.5">
            Cancel This Appointment?
          </Typography>
          <Typography variant="body2" className="text-[var(--mui-palette-text-secondary)] mb-4">
            This will free up the slot and notify the candidate. This action can't be undone.
          </Typography>
          <TextField
            multiline
            rows={2}
