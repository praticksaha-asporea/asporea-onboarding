                ...
                {isFormDisabled && (
                  ...
                  >
                    <Box className="flex items-center gap-3 text-left">
                      <Box className="zw-14 h-14 rounded-full  bg-[var(--mui-palette-primary)] flex items-center justify-center text-[var(--mui-palette-text-secondary)] shrink-0 shadow-sm">
                  ...
                  <Card>
                    <CardContent className="mbe-5">
                      <Grid container spacing={5}>
                        ...
                        <Grid size={{ xs: 12, md: 6 }}>
                          <FormControl fullWidth error={err("inquiryFor")} disabled={!formik.values.inquiryCategory || isFormDisabled}>
                            ...
                            <Select
                              ...
                              label={formik.values.inquiryCategory ? "Select Position" : "Select a category first"}
                              name="inquiryFor"
                            ...
                            >
                              {positionData && !positionData.grouped &&
                            ...
                            {err("inquiryFor") && <FormHelperText>{helperText("inquiryFor")}</FormHelperText>}
                          </FormControl>
                        </Grid>
                        {/* </Grid> */}
                      </Grid>
                      ...
                      <Grid container spacing={5}>
                        <Grid size={{ xs: 6, md: 6 }}>
                          <FormControl fullWidth error={err("nationality")}>
                            ...
                            {err("nationality") && <FormHelperText>{helperText("nationality")}</FormHelperText>}
                          </FormControl>
                        ...
                        <Grid size={{ xs: 6, md: 6 }}>
                          <FormControl fullWidth error={err("nationality")}>
                            ...
                            {err("latestAcademic") && <FormHelperText>{helperText("latestAcademic")}</FormHelperText>}
                          </FormControl>

                        </Grid>
                        <Grid size={{ xs: 6, md: 6 }}>
                          <FormControl fullWidth error={err("latestTechnical")}>
                            <InputLabel id="inquiry-latestTechnical-label">
                              Latest Technical qualifications
                            </InputLabel>
                            <TextField
                              fullWidth
                              type="text"
                              name="latestTechnical"
                              label="Latest Technical qualifications"
                              // value={formik.values.latestTechnical} 
                              onChange={formik.handleChange}
                              error={err("latestTechnical")}
                              helperText={helperText("latestTechnical")}
                            />
                            {err("latestTechnical") && <FormHelperText>{helperText("latestTechnical")}</FormHelperText>}
                          </FormControl>

                        </Grid>
                        <Grid size={{ xs: 6, md: 6 }}>
                          <FormControl fullWidth error={err("workExperience")}>
                            <InputLabel id="inquiry-workExperience-label">
                              Work Experience
                            </InputLabel>
                            <TextField
                              fullWidth
                            ...
                            />
                            {err("workExperience") && <FormHelperText>{helperText("workExperience")}</FormHelperText>}
                          </FormControl>
