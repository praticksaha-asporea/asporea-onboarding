...
import { Box, capitalize, Checkbox, FormControlLabel, FormGroup, FormHelperText, FormLabel, Paper, Radio, RadioGroup, Step, StepContent, StepLabel, Stepper } from '@mui/material'
        ...
        <Grid size={{ xs: 6, md: 9 }}>
          <Card>
            <CardContent>
              ...
              <Typography variant='subtitle1' className='pb-5'>Please fill out the form below to register an inquiry</Typography>
                  ...
                  <CardContent className='mbe-5'>
                    <Grid container spacing={5}>
                      ...
                      <Grid size={{ xs: 12, md: 6, sm: 12 }}>
                        <FormControl fullWidth>
                          ...
                          <Select
                            ...
                            onChange={e => handleFormChange('prefferedBranch', e.target.value)}
                          >
                            <MenuItem value='siliguri'>Siliguri (Within 1 Km)</MenuItem>
                      ...
                      <Grid size={{ xs: 12, md: 6, sm: 12 }}>
                        <FormControl fullWidth>
                          ...
                          <Select
                            ...
                            onChange={e => handleFormChange('prefferedConsultant', e.target.value)}
                          >
                      ...
                      <Grid size={{ xs: 12, md: 12, sm: 12 }}>
                        <FormControl fullWidth>
                          <RadioGroup aria-label='Visit Option' value={formData.visitOption}
                            onChange={e => handleFormChange('visitOption', e.target.value)}>
                            <FormControlLabel value={1} control={<Radio />} label='Are you currently now in this branch? (Only use while you are in branch premises)' />
                            <FormControlLabel value={0} control={<Radio />} label='Are you visiting this branch?  (Only use while you are outside and willing to visit in-person )' />
                            <FormControlLabel value={2} control={<Radio />} label='Want to visit online rather than in-person branch visit' />
                          </RadioGroup>
                          <FormHelperText>NOTE: Online Schedule you can choose from next screen, If you have preferred consultant.</FormHelperText>
                        </FormControl>
                      </Grid>
                      <Grid size={{ xs: 12, md: 12, sm: 12 }}>
                        <TextField
...
700001`}
                ...
                <Card className='mt-5'>
                    ...
                    <Grid container spacing={5}>
                      <Grid size={{ xs: 12, md: 6, sm: 12 }}>
                        <FormControl fullWidth>
                          ...
                          <RadioGroup row aria-label='Refered From' value={formData.referedFrom}
                            onChange={e => handleFormChange('referedFrom', e.target.value)}>
                      ...
                      <Grid size={{ xs: 12, md: 6, sm: 12 }}>
                        ...
                        <FormControl fullWidth >
                          ...
                          <RadioGroup row aria-label='Refered Type' value={formData.referedType}
                            onChange={e => handleFormChange('referedType', e.target.value)}>
                      ...
                      <Grid size={{ xs: 12, md: 6, sm: 12 }}>
                        ...
                        <FormControl fullWidth >
                          <InputLabel>Name of {capitalize(formData.referedType)}</InputLabel>
                          <Select
                            label='referedBy'
                            value={formData.referedBy}
                            onChange={e => handleFormChange('referedBy', e.target.value)}>
                            <MenuItem value={`1`} >{capitalize(formData.referedType) + ` 1`}</MenuItem>
                            <MenuItem value={`2`} >{capitalize(formData.referedType) + ` 2`}</MenuItem>
                            <MenuItem value={`3`} >{capitalize(formData.referedType) + ` 3`}</MenuItem>
                          </Select>
                      ...
                      <Grid size={{ xs: 12, md: 6, sm: 12 }}>
                        ...
                        <FormControl fullWidth >
                          <TextField
                            ...
                            onChange={e => handleFormChange('otherReferedBy', e.target.value)}
                          />
                  ...
                  <CardContent className='mbe-5'>
                    ...
                    <Grid container spacing={5}>
                      <Grid size={{ xs: 12, md: 12, sm: 12 }} className='flex gap-4 flex-wrap justify-end'>
        ...
        <Grid size={{ xs: 6, md: 3 }}>
          ...
          <Grid container spacing={5}>
            <Grid size={{ xs: 12, md: 12, sm: 12 }}>
              <Card>
                <CardContent>
                    <Typography variant='h5' className='mb-5'>Application Progress</Typography>
