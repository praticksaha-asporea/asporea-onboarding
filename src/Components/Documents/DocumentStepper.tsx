...
import { Step, StepConnector, stepConnectorClasses, StepIconProps, StepLabel, styled } from "@mui/material";
...
export const DocumentStepper = ({ activeStep }: { activeStep: number }) => {
