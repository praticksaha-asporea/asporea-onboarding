...
import { updatePreAssignmentService } from "@/lib/services/tac/update-pre-assignment.service";
...
export default async function handler(
  ...
  try {
    ...
    const updated = await updatePreAssignmentService(body, authUser, files);
