...
import { updateAssessDocumentService } from "@/lib/services/tac/update-assess-document.service";
...
export default async function handler(
  ...
  try {
    ...
    const updatedLead = await updateAssessDocumentService(body, authUser);
