...
import { viewQuestion } from "@/lib/services/Assessments/question.service";
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const data = await viewQuestion(id as string);

    return ResponseHandler.sendSuccess(res, data, "Question details fetched successfully");
  } catch (error: unknown) {
