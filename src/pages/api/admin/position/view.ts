...
import { viewPosition } from "@/lib/services/admin/position.service";
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const data = await viewPosition(positionId);
    return ResponseHandler.sendSuccess(res, data, "Position fetched successfully");
  } catch (error: unknown) {
