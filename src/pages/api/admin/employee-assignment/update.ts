...
import { updateAssignment } from "@/lib/services/admin/employeeAssignment.service";
import { updateAssignmentSchema } from "@/lib/validation/employeeAssignmentValidation";
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const updated = await updateAssignment(id, updateData);

    return ResponseHandler.sendSuccess(res, updated, "Assignment updated successfully");
  } catch (error: unknown) {
