...
const CandidateMenu = ({ scrollMenu }: { scrollMenu: (container: any, isPerfectScrollbar: boolean) => void }) => {
  // Hooks
  ...
  return (
    ...
    >
      ...
      >
          ...
          <MenuItem href='/account-settings' icon={<i className='material-symbols--format-list-bulleted' />}>
            Application Status
          </MenuItem>
        {/* <SubMenu
          label='Dashboards'
